...
We use the **MediaPipe Tasks Vision** library to get 21 hand landmarks in 3D (mapped to 2D for this project). We specifically target the fingertips and wrist as points of influence, allowing multiple points of interaction per hand.
